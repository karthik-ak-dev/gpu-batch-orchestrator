...
if __name__ == "__main__":
    ...
    print("=== JOB1 DEBUG ===", file=sys.stderr)
    ...
    # Process the data (Job1's logic)
    result = {
        "job1_input": input_data,
    ...
    s3_key = f"{execution_id}/job1-result.json"

    if write_to_s3(s3_client, s3_bucket, s3_key, result):
        print("Job1 completed successfully", file=sys.stderr)
    else:
        print("Job1 failed to write output", file=sys.stderr)
        exit(1)
